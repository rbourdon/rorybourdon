...
const blobV = {
  hidden: { x: -330, y: 190 },
  visible: (custom) => ({ x: custom ? -330 : 0, y: custom ? 190 : 0 }),
  selected: (custom) => ({ x: custom ? -330 : 0, y: custom ? 190 : 0 }),
};
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 846.02 713.53">
        ...
        >
          <path
            fill="#37373f"
            d="M398.6 185.7a8.73 8.73 0 0 1 8.71 8.7v17.4a8.73 8.73 0 0 1-8.7 8.7h-17.4a8.73 8.73 0 0 1-8.7-8.7v-17.4a8.73 8.73 0 0 1 8.7-8.7h17.4m0-3.49h-17.4a12.22 12.22 0 0 0-12.19 12.18v17.4A12.22 12.22 0 0 0 381.2 224h17.4a12.22 12.22 0 0 0 12.2-12.2v-17.4a12.22 12.22 0 0 0-12.2-12.18Z"
          />
          <path
            fill="#37373f"
            d="M401.22 194.4a2.61 2.61 0 1 1 2.6-2.62 2.6 2.6 0 0 1-2.6 2.61Zm-11.31 1.74a6.96 6.96 0 1 1-6.97 6.96 6.97 6.97 0 0 1 6.97-6.96m0-3.49a10.44 10.44 0 1 0 10.44 10.45 10.45 10.45 0 0 0-10.44-10.45Z"
          />
        </motion.g>
        {/* LinkedIn */}
        <motion.path
